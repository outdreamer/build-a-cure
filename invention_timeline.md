...
## example posts containing inventions or unique points/jokes that were copied by other people
	...
	- I identified:
		...
		- the patterns in problem-solving workflows, or abstract, structure, & automate workflows & thoughts
		...
		- solving a problem was possible using logic vs. using facts
	...
	- I applied my invention to explain how to solve specific problems, like by explaining:
		- dictators/war/human nature to governments so they wouldnt have to go to war anymore, specifically how to connect perspectives across conflicts like wars in a way that doesnt invalidate either side - because if you dont connect the warring perspectives, conflicts will continue
		- how they could identify new viruses/species by applying changes to known species based on common change types/functions, which is a default analysis rule in my invention's configuration
		- that people could use known methods to design drugs that are non-addictive, which they then started researching - https://phys.org/news/2021-07-addictive-opioids-chemistry.html
		- that poverty costs more than it would take to end it
		- how to fix biased AI algorithms
		- why symmetries (which I convert to the term 'interfaces') are useful for automating problem-solving, at which point people started using them & my other variations of the definition in ML algorithms
		- topical insights powering solutions in various specific domains, like that 'cell communication is a fundamental property that can be used to cure cancer, and so can my stressor/change supply & demand model'
...
## summary of invention timeline
	...
	- I was taught that:
		- problems could be solved in multiple ways
			...
			- addressing 'how' to solve a problem vs. 'why' it existed (root cause)
...
- useful structures identified
	...
	- problem-solving rule patterns
		- I decided to try to automate problem-solving once I saw patterns in the rules people used to solve problems, and once I found an example proof of concept, I pursued it.
	...
	- math-language map: 
		- I think about 'unit cases' or 'proof of concept examples' often, so I realized the standard operation of division was like applying the lower number as a standardizing transform on the upper number. Once I realized that division was a standardizing operation, I realized it had similarities to interfaces, which are more indexable as a semantic (linguistic) object than a structural one. I explored the concept of meaning in relation to these objects, and arrived at a structural definition of meaning: 
		- the 'meaning' of an object included the structures of that object in a relevant system, possibly aligning across multiple related systems
			...
			- you can frame this tool (or its network of interfaces, as a meaning interface) as meaning detection/derivation/generation automation.
			- meaning can take several forms in different systems:
				...
				- the relevant structures of an object:
			...
			- meaning can help you identify answers to questions like 'what is the important object' or 'what is the better priority'
	...
	- detachment: 
		...
		- i also saw patterns in problems, patterns that seemed to be unaddressed with current solutions - like common error types (dependency/version mismatch) & security incidents (misaligned permissions with intents) or unnecessary work (manual learning of correct parameters to use in an ml model, without understanding).

  ...
  - objects: 
    ...
    - these objects can be defined as combinations of general interface objects (object/attribute/type) and core structures/functions/attributes 
      ...
      - perspectives: a filter/priority/rule set, optionally having structures like object positions & default rules, produceable with a chain of distortions from a default perspective; a priority set with object positions & default paths
  ...
  - answers questions like: 
    - how to organize information in optimal structures (optimal path/distribution/states)
    ...
    - identify structures (layer/format) & relevant objects needed to solve a problem 

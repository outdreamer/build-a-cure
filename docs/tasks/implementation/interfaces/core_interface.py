'''
  ...
  - structures
    - core structures (intersections, hubs, vertices, maps, points, filters, limits, boundaries, symmetries, & alignments)
    - core spaces: default sets or other structures where this object can develop 

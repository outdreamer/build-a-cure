...
- useful sub-intents with associated substances
	...
	- for an example of a treatment strategy, combining the following sub-intents is probably useful across different cancers:
		...
		- increase cortisol at night using exercise/grapefruit/citrus/caffeine/resveratrol/licorice/blue light (or steroid hormones like pregnenolone/hydrocortisone/other glucocorticoids/corticosteroids if youre otherwise healthy and can tolerate them), bc night is when these hormones naturally decrease and stop suppressing cancer cell growth (lower cortisol at night is why cancer grows more at night)

...
- useful sub-intents with associated substances
	...
	- these are probably useful sub-intents/substances for treating cancer (assuming no liver/kidney damage which would contraindicate the harsher substances like temozolomide, disulfiram, baicelein, celastrol, and quercetin), based on identifying treatments in ncbi.nlm.nih.gov articles, these are not inventions
		...
		- 'cancer cause' diagnostic sequence
			- you will probably want to rule out causes/enhancers of your cancer in specific sequences
				...
				- then check if 'low immunity' causes your cancer to grow, by stimulating immunity/klotho (klotho being a tumor suppressor) with high intensity interval training (half an hour of sprinting/resting cycles)
				...
				- if these dont work, youll want to keep looking for other pollutants/chemicals you might be exposed to that could cause cancer (like alcohol, pesticides, toxic cleaning chemicals, processed food, supplements like beta-sitosterol that can suppress tumor-fighting defenses, arginine/b vitamins/vitamin c/vitamin e/iron/zinc which can feed cancer if taken in supplement form, etc)
	...
	- for an example of a treatment strategy, combining the following sub-intents is probably useful across different cancers:
		...
		- increasing klotho with senolytics/exercise/fasting/supplements
			- klotho is a universal tumor suppressor (results in inhibition of major signaling pathways, reducing oxidative stress and suppressing inflammation)
				- https://www.nature.com/articles/s41388-022-02440-5
		...
		- inhibit cancer stem cells (vitamin C, milk thistle, chloroquine, apigenin, turmeric, berberine, calestrol, emodin, moringa, fisetin, limonene, withaferin, rosmarinic acid, quercetin, astaxanthin, icariin, tricin)
			...
			- inhibit CDK5
				...
				- sulforaphane - https://pubmed.ncbi.nlm.nih.gov/36508924/
		...
		- if youre used to using a nightlight and/or your cancer grows more at night, try increasing your cortisol at night using high intensity exercise/stressful noises like alarms/blue light from devices/other artificial light, or substances that increase cortisol like grapefruit/citrus/caffeine/resveratrol/licorice (or steroid hormones like pregnenolone/hydrocortisone/other glucocorticoids/corticosteroids if youre otherwise healthy and can tolerate them)
			...
			- 'increasing cortisol at night' isnt a permanent or long-term solution or a habit that you should use every day, bc cortisol at night will disrupt your circadian rhythm, but as a treatment for cancer, it could slow cancer growth enough for your morning treatments to be more effective (especially if you only occasionally increase your cortisol at night or otherwise allow your circadian rhythms to go back to normal regularly enough to get benefits from correct circadian rhythms, like immune responses in the morning)
			- be aware that licorice can cause hypertension and low blood potassium and steroids/hormones also have possibly harmful side effects in trivial/normal doses, especially if you have other health conditions like kidney/heart damage
			- some of these cortisol-increasing substances may only increase general cortisol levels or only increase cortisol when it naturally increases (in the morning), rather than at the time of use, and they may also decrease cortisol in some cases or will have a lower response of increasing cortisol only slightly (after tolerance to the substance develops), and they may only decrease cortisol up to the normal healthy level if you were deficient in cortisol, or they may only prevent the decrease of cortisol rather than increasing it, or they may only increase your cortisol levels for a few minutes or hours, rather than the whole night
			...
			- avoid taking cortisol-lowering substances at night and only use them in the morning if possible (turmeric, chocolate, sea salt, olive oil, siberian ginseng/eleuthoro, bananas/tryptophan, mushrooms/oats/barley/beta-glucans, garlic, flaxseed/alpha-linolenic acid, ginger, onions/quercetin, asparagus/rutin/glutathione, ginkgo biloba, tyrosine, suma root, nutritional yeast, cordyceps, probiotics/prebiotics, astragalus, holy basil, NAC, tribulus, B-vitamins, zinc, bacopa, cannabis/cbd, ginseng, ashwagandha, rhodiola, lemon balm, chamomile, GABA, melatonin, vitamin D, theanine, magnolia/honokiol, phosphatidylserine/choline, schisandra, omega-3s, green tea/EGCG, vitamin C, magnesium)
		...
		- inhibit growth factors
			...
			- inhibit IGF-1R (quercetin)
		    	...
		    	- there is a link between certain disruptive BAP1 variants and higher levels of IGF-1, a hormone and growth factor
		    		- https://medicalxpress.com/news/2024-07-scientists-thousands-high-cancer-gene.html
	...
	- increase interleukins which suppress tumors, avoid interleukins which promote tumors
		...
		- helps tumors
			- IL 1, 4, 6, 8, 10, 11, 13, 17, 20, 22, 23, 27, 33, 35
				- turmeric increases 11, omega‑3 polyunsaturated fatty acids decrease IL-11
		...
		- increase IL-12 (tumor suppressor)
			- use IL-12 activators
				...
				- beta glucans increase IL-12
					- https://pubmed.ncbi.nlm.nih.gov/25081694/
			...
			- avoid IL-12 inhibitors
				...
				- corticosteroids inhibit IL-12
					- https://pubmed.ncbi.nlm.nih.gov/11080718/

  ...
  - add to ml
    ...
    - add to structures
      - what are variables of useful structures? the variables of usefulness like 'minimizing work' such as 'stored future work'
        ...
        - the common theme of useful structures is that they generate differences that are likely to create differences in structures that are useful for being measurable, likely to be interacted with, likely to cause other structures
        ...
        - 'functions' and 'networks' are useful in being 'maximally different structures', similar to how 'concepts' and 'cause' are useful for the maximal differences they describe

# to do
  ...
  - problem definition
    ...
    - apply solution automation workflow 'break into sub-problems & integrate sub-solutions'
      ...
      - identify sub-problems of problem structure
        - sub-problems of solution automation workflow
  ...
  - problem: 'find a prediction/regression function/line'
    ...
    - sub-problems:
      ...
      4. apply structure to integrate components
        - find specific operations to fulfill the component integration structure found in 3 (match the component integration structure & its specific application with the solution structure)

...
## examples
  ...
  - add to solution automation workflows
    ...
    - apply changes to the attributes like position of a useful structure in a solution-finding method to implement the intent of the useful structure in its original position in a different way

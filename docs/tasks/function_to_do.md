...
## examples
  ...
  - add to solution automation workflows
    ...
    - identify useful structures like 'optimization interchangeables' ('alternatives to optimize that can effectively replace other structures to optimize') that can fulfill problem-solving intents like 'avoid errors' and 'apply generally successful solution or optimization structures'

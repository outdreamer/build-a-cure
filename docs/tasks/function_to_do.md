...
## examples
  ...
  - add to solution automation workflows
    ...
    - identify structures (such as a number of significant or accessible structural similarities) required to apply structures from other systems to automatically find useful structures to apply as templates for problem-solving structures, filtering the set of structures produced by an 'input-output sequence' similarity with additional similarities or other structures that indicate enough relevance to apply the structure to other problems requiring the original structure

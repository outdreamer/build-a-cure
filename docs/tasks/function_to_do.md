          ...
          - connections between:
            ...
            - solution/problem (the objects or their components/attributes/functions)
              ...
              - solution space & problem space
                - these are coordinating structures to generate opposite structures to the problem
                  ...
                  - a problem of 'find a prediction function' in a problem space where 'variable interactions are uncertain' & the solution space of 'possible prediction functions or function-finding methods to equal dependent & independent variables with some accuracy value', where the solution space is 'a subset of all variable interactions, filtered by variables of the problem definition & by possible variable interactions'

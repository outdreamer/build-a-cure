...
## examples
  ...
  - add to examples
    ...
    - add to solution automation workflows
      ...
      - identify useful structures like 'opposites' that are useful for multiple core intents like 'find differences' and 'apply difference' and 'filter' which are adjacently useful to problem-solving intents like 'filter solution space', when applied to specific structures like 'the set of (interchangeable alternates and requirements)'

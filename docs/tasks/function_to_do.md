...
## examples
  ...
  - add to examples
    ...
    - add to solution automation workflows
      ...
      - identify useful structures like 'contradictions of insights' that can identify 'useful changes to apply to existing solution-finding methods' in a particular problem format like 'find a prediction function'
        ...
        - similarly other insights like 'isolating connections of a variable set is rarely useful without context' is another insight that can adjacently derive interface structures (like the 'cause' of the variables)

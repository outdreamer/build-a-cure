# to do
  ...
  - example prediction using different bases
    ...
    - how can you integrate this structure into an absolute time-based prediction function
      ...
      - organize the function as a structure (like a network or tree) of components once theyre derived (bases, randomness injections, composing functions, vectors) & test it on subsets of the data set

...
## examples
  ...
  - add to ml
    ...
    - add to structures
      ...
      - solving for the 'differences in equation sets that can be resolved by a particular matrix set' is another useful structure to identify & store (and identify variables of the same), as a way of finding 'coordinating function that can co-exist in the same cohesive system'

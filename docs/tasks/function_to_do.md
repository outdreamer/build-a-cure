...
## examples
  ...
  - add to ml
    ...
    - add to structures
      ...
      - the concept of a 'surface/lining' is useful for determining structures of limits that determine its interactions with other structures, similar to how exteriors can summarize interior processes and a lining of a shape can determine its interaction potential with other structures
      - an 'overlap' can be created by many other structures like a circular cycle, a common input, a compressed fold, a wave that represents such incremental changes that it appears to be or overlaps with a line, etc
        - these structures like 'overlap' are useful to specify bc of these highly variable structures they can take in different systems

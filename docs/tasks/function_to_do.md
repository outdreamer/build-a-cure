...
## examples
  ...
  - add to solution automation workflows
    ...
    - derive interface queries of known solutions and identify other interface queries that could be applied to generate other solutions, where known solutions are inefficient, impractical, or sub-optimal

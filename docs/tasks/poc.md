...
def get_problem_metadata(problem_statement):
  ...
  this function answers the question: 'given input resources of interface_objects['interface_functions'] & the problem difference between input/output format, how can conversions be applied to connect input/output format'
  '''
  ...
  - the interface metadata (intents, functions, insights) can be derived from the definition

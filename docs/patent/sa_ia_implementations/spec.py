...
[0002] Interface components like problem-solving automation workflow insight paths can be found/generated/derived/applied & implemented with various methods, such as by applying structures of problem/solution components/variables/structures, as the examples included specify. These example implementations specify logic that can be used to implement the components referenced in US patent applications 16887411 & 17016403, which extend the implementation example sets given in those inventions.

ABSTRACT 

[0003] Solution automation & interface analysis components can be implemented in many ways, such as by specifying input/outputs & training a learning (generate, test & update) algorithm on the input/output data to generate a prediction function, to replace logic connecting input & outputs. Alternatively, specific logic implementations to connect input/output of sub-tasks to implement solution automation & interface analysis are included in the specification of this invention.
...
[0010] Structural concept definition routes
...
[0052] Example of applying solution automation workflow
...
[0088] Apply insight path to solve problem of 'find factors to produce number without using multiplication of every combination'

- chatgpt queries to solve reality
	...
	- to do list
		...
		- other queries to run
			...
			- what structures could exist or be created that could end reality before its solved, like a quantum entanglement cascade or a randomness-generating device, that could get out of control and destroy the universe before it can be computationally solved

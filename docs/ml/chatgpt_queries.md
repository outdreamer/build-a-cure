...
- to do list
	...
	- other queries
		...
		- what are optimal states like states where intents like 'identifying a graph of all logic interactions (the end of logic)' are implemented, and what are the opposites of these optimal states like 'errors that could prevent the optimal states like "missing definitions/functions/tests of logic structures" (so logic only seems complete but is missing structures like complete definitions/connections/specifications)' and what are graphs connecting these optimal states and their opposites and what are the graphs connecting these connections between opposites (like 'start from a graph of common errors preventing these optimal states and connect to surrounding optimal states')
			- relatedly, 'what are maximally different relevant graphs that connect maximally different relevant graphs' is an unsolved intent that can be solved with a 'complete definition of relevance'
